...
@interface WalletCouponViewController ()
{
    WalletCouponView *mainView;
...
@implementation WalletCouponViewController
...
- (void)viewDidLoad {
    ...
    mainView=[[WalletCouponView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
...
- (void)showLeaderboardForWalletCoupon:(NSString *)name
{
    ...
    NSString *siteurl = [NSString stringWithFormat:@"http://xbowling.cloudapp.net/Coupon/Index?VenueId=15103&Token="];
