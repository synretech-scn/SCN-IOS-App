...
- (void)createView
{
    ...
    NSArray *imagesArray=[[NSArray alloc]initWithObjects:@"morexb.png",@"moreoc.png",@"morewc.png", nil];
...
//        iconImageView.center=CGPointMake(iconImageView.center.x,baseView.center.y);
        ...
        if(i<3)
            [viewButton setTitle:@"Visit" forState:UIControlStateNormal];
        else
...
{
    [delegate showLeaderboardForMore:championship];
}
@end
