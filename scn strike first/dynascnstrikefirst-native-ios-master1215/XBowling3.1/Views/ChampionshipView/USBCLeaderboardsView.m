...
#import "USBCLeaderboardsView.h"

@implementation USBCLeaderboardsView
@synthesize delegate;
...
- (void)createView
{
    ...
    NSArray *imagesArray=[[NSArray alloc]initWithObjects:@"xb.png",@"oc.png",@"wc.png", nil];
...
{
    [delegate showLeaderboardForChampionship:championship];
}
@end
