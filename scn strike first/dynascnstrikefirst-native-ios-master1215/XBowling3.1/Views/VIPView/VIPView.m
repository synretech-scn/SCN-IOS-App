...
- (void)createView
{
    ...
    NSArray *imagesArray=[[NSArray alloc]initWithObjects:@"vipxb.png",@"vipoc.png",@"vipwc.png", nil];
...
//        iconImageView.center=CGPointMake(iconImageView.center.x,baseView.center.y);
        ...
        [viewButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
             if(i<3)
        [viewButton setTitle:@"Enter" forState:UIControlStateNormal];
        else
...
{
    [delegate showLeaderboardForVIP:championship];
}
@end
