...
- (void)createView
{
    ...
    headerLabel.text=@"League Standings";
    ...
    NSArray *imagesArray=[[NSArray alloc]initWithObjects:@"leaguexb.png",@"leagueoc.png",@"leaguewc.png", nil];
...
//        iconImageView.center=CGPointMake(iconImageView.center.x,baseView.center.y);
        ...
        if(i<3)
            [viewButton setTitle:@"Check" forState:UIControlStateNormal];
...
{
    [delegate showLeaderboardForLeague:championship];
}
@end
