...
- (void)createView
{
    ...
    headerLabel.text=@"Special Promotions";
    ...
    NSArray *imagesArray=[[NSArray alloc]initWithObjects:@"couponxb.png",@"couponoc.png",@"couponwc.png", nil];
...
{
    [delegate showLeaderboardForCoupon:championship];
}
@end
