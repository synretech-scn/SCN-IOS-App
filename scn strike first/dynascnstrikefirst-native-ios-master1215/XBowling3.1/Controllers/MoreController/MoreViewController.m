...
- (void)viewDidLoad {
    ...
    mainView=[[MoreView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
...
- (void)showLeaderboardForMore:(NSString *)name
{
    ...
    if ([name isEqualToString:@"OC"]) {
        url=[NSURL URLWithString:@"http://xbowling-mobile.trafficmanager.net/LearnMore?venueId=15103"];
    }
