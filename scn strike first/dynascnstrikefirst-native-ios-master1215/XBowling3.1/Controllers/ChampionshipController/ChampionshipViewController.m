...
@interface ChampionshipViewController ()
{
    USBCLeaderboardsView *mainView;
...
@implementation ChampionshipViewController
...
- (void)viewDidLoad {
    ...
    mainView=[[USBCLeaderboardsView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
...
- (void)showLeaderboardForChampionship:(NSString *)name
{
    ...
    if ([name isEqualToString:@"OC"]) {
        url=[NSURL URLWithString:@"http://www.xbowling.com/usbc-championship/USBC-Open-Championships-2015"];
    }
    else if([name isEqualToString:@"WC"]){
        url=[NSURL URLWithString:@"http://www.xbowling.com/usbc-championship/USBC-Womens-Championships-2015"];
        
    }
    else if([name isEqualToString:@"ITC"]){
        url=[NSURL URLWithString:@"http://www.xbowling.com/usbc-championship/USBC-Intercollegiate-Team-Championships"];
    }
    else{
