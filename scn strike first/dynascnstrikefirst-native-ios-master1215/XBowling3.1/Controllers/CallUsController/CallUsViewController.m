...
- (void)viewDidLoad {
    ...
    mainView=[[CallUsView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
...
- (void)showLeaderboardForCallUs:(NSString *)name
{
    ...
    if ([name isEqualToString:@"OC"]) {
        url=[NSURL URLWithString:@"http://xbowling-mobile.trafficmanager.net/Home/Generic?Name=findus&VenueId=15103"];
    }
